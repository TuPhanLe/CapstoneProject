...
<div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0" style="font-size: 25px;">VƯỜN RAU MUỐNG</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    <span class="text-bold text-lg" id="jv-humi" ></span>
                  </p>
                  <p class="ml-auto d-flex flex-column text-right">
                    <span class="text-success">
                    </span>
          ...
          <div class="card">
              ...
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    <span class="text-bold text-lg" id="jv-soil"></span>
                  </p>
                  <p class="ml-auto d-flex flex-column text-right">
                    <span class="text-success">
                    </span>
        ...
        <div class="card">
              ...
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    <span class="text-bold text-lg" id="jv-light"></span>
                  </p>
                  <p class="ml-auto d-flex flex-column text-right">
                    <span class="text-success">
                    </span>
  ...
  const CSoil = document.getElementById('js-Chart-Soil');
    ...
    setTimeout(() => {
        window.Echo.channel('BroadcastDataNode2')
            .listen('.App\\Events\\BroadcastDataNode2', (e) => {
            console.log(e);
            temp = e['temp'];
            humi = e['humi'];
            soil = e['soil'];
            ...
            document.getElementById('jv-time').innerHTML = time;
            setDataChartTemp(e);
            setDataChartHumi(e);
            setDataChartSoil(e);
            setDataChartLight(e);
